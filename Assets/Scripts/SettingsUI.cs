...
public class SettingsUI : MonoBehaviour
{
	...
	private void OnDisable()
	{
		...
		qualitySettings.onValueChanged.RemoveListener(SetQuality);
		...
		PlayerPrefs.SetInt("Quality", qualitySettings.value);
	...
	private void SetQuality(int val)
	{
